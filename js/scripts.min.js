$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Albert and Mica's Wedding",

            // Event start date
            start: new Date('Dec 11, 2021 15:30'),

            // You can also choose to set an end time
            // If an end time is set, this will take precedence over duration
            end: new Date('Dec 11, 2021 21:00'),

            // Event Address
            address: 'Malolos Cathedral',

            // Event Description
            description: "The wedding ceremony will take place at MALOLOS CATHEDRAL and reception will follow at MANHATTAN, Tikay, Malolos, Bulacan"
        }
    });
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        // if not attending, remaining inputs are optional
        if (!$('#not_attend').is(":checked")) {
            if ($('#guestname').val()                       == "" 
                || $('#phone').val()                        == "" 
                || $('#extras').val()                       == "" 
                || $('#invite_code').val()                  == ""
                || $('input[name=Location]:checked').length == 0
            ) {
        ...
        $.post('https://script.google.com/macros/s/AKfycbxQZKFgRMUZOp4uAN7rXHMNpb4rNLDMpzFSYALjmdaRGCjF69mxfPh-cQasfNXbC7s/exec', data)
                            .done(function (data) {
                                console.log(data);
...
// Google map
function initMap() {
    var itc_kol = {lat: 14.124988, lng: 120.959279};
